...
<div class="container">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                <h4 class="card-title">{{ trans('message.add_project') }}</h4>
                <p class="card-description">{{ trans('message.fill_in_project') }}</p>
                <form action="{{ route('researchProjects.store') }}" method="POST">
                    ...
                    <div class="form-group row mt-2">
                        <label for="exampleInputfund_details" class="col-sm-2 ">{{ trans('message.choose_funding') }}</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputproject_year" class="col-sm-2 ">{{ trans('message.requested_year') }}</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row mt-2">
                        <label for="exampleInputresponsible_department" class="col-sm-2 ">{{ trans('message.funding_support') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mt-2">
                        <label for="exampleInputfund_details" class="col-sm-2 ">{{ trans('message.project_detail') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mt-2">
                        <label for="exampleInputfund_details" class="col-sm-2 ">{{ trans('message.project_leader') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        @else
                            <label for="exampleInputfund_details" class="col-sm-2 ">Co-Project Leader (Internal)</label>
                        @endif
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mt-2">
                        @if(app()->getLocale() == 'th')
                            <label for="exampleInputpaper_doi" class="col-sm-2 ">ผู้รับผิดชอบโครงการ (ร่วม) ภายนอก</label>
                        @else
                            <label for="exampleInputpaper_doi" class="col-sm-2 ">Co-Project Leader (External)</label>
                        @endif
                        <div class="col-sm-9">
                            <div class="table-responsive">
                                <table class="table table-hover small-text" id="tb">
                                    <tr class="tr-header">
                                        <th>{{ trans('message.position') }} {{ trans('message.or') }} {{ trans('message.prefix') }}</th>
