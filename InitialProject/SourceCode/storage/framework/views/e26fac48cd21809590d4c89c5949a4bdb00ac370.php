...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title"><?php echo e(trans('message.user')); ?></h4>
            ...
            <a class="btn btn-primary btn-icon-text btn-sm" href="<?php echo e(route('importfiles')); ?>"><i class="ti-download btn-icon-prepend icon-sm"></i><?php echo e(trans('message.import_user')); ?></a>
                ...
                <table id="example1" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(trans('message.department')); ?></th>
                            <th>Email</th>
                            <th><?php echo e(trans('message.role')); ?></th>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\year3_2\softwareEng\soften_jectgroup\git-group-repository-group-2-sec-1\InitialProject\SourceCode\resources\views/users/index.blade.php ENDPATH**/ ?>