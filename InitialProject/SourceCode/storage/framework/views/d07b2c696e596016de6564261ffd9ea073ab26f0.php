...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title"><?php echo e(trans('message.publications2')); ?></h4>
                ...
                <table id="example1" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(trans('message.publication_year')); ?></th>
                            <!-- <th>ผู้เขียน</th>   -->
                            <!-- <th>Source Title</th> -->
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\year3_2\softwareEng\soften_jectgroup\git-group-repository-group-2-sec-1\InitialProject\SourceCode\resources\views/papers/index.blade.php ENDPATH**/ ?>