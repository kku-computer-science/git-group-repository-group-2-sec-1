                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="events-container" style="max-height: 400px; overflow-y: auto;">
                            ...
                            <?php if(!empty($apiCallWarning) || !empty($loginFailed)): ?>
                                <?php if(!empty($apiCallWarning)): ?>
                                    <div class="list-group">
                                        <?php $__currentLoopData = $apiCallWarning; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($event['date'] === session('selectedDate', date('Y-m-d'))): ?>
                                                <a href="#"
                                                    onclick="redirectToLogs(event, this.dataset.url, '<?php echo e($event['type']); ?>')"
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-2">
                                                            <p class="mb-1 text-primary fw-semibold">
                                                                <?php echo e($event['user_pointer']); ?></p>
                                                            <p class="mb-1 text-dark"><?php echo e($event['description']); ?></p>
                                                        </div>
                                                        <small class="text-muted d-block mt-2">
                                                            <i class="far fa-clock me-1"></i><?php echo e($event['last_call']); ?>&nbsp; ผ่านไปแล้ว <?php echo e($event['time_diff']); ?> นาที
                                                        </small>
                                                    </div>
                                                </a>
                                            <?php endif; ?>
                                ...
                                <?php if(!empty($loginFailed)): ?>
                                    <div class="list-group">
                                        <?php $__currentLoopData = $loginFailed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($event['date'] === session('selectedDate', date('Y-m-d'))): ?>
                                                <a href="#"
                                                    onclick="redirectToLogs(event, this.dataset.url, '<?php echo e($event['type']); ?>')"
                                                    data-url="<?php echo e(route('logs.index')); ?>"
...
<?php $__env->stopSection(); ?>
<?php /**PATH E:\year3_2\softwareEng\soften_jectgroup\git-group-repository-group-2-sec-1\InitialProject\SourceCode\resources\views/dashboardLog/index.blade.php ENDPATH**/ ?>