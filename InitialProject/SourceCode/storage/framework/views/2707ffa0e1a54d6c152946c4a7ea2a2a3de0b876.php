...
<!-- Main Script -->
<script src="<?php echo e(asset('js/activity-report.js')); ?>"></script>
<link href="<?php echo e(asset('css/report-log.css')); ?>" rel="stylesheet">

<?php $__env->startSection('title', 'รายงานกิจกรรมผู้ใช้งานในระบบ'); ?>
    ...
    <div class="content-wrapper px-3">
        ...
        <div class="card page-header-card mb-4 border-0 shadow-sm">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('logs.index')); ?>" class="btn back-button text-white btn-sm">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const activityTypeConfig = <?php echo $activityTypes; ?>;
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\year3_2\softwareEng\soften_jectgroup\git-group-repository-group-2-sec-1\InitialProject\SourceCode\resources\views/exportLogReport/index.blade.php ENDPATH**/ ?>