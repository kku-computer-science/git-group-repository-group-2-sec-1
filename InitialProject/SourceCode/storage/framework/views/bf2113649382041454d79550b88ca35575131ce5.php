    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('exportLogReport.index')); ?>" class="btn btn-primary">Export Report</a>
            </div>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\year3_2\softwareEng\soften_jectgroup\git-group-repository-group-2-sec-1\InitialProject\SourceCode\resources\views/logs/index.blade.php ENDPATH**/ ?>