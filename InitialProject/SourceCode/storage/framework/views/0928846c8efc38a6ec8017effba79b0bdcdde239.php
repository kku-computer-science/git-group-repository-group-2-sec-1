            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"><?php echo e(trans('message.research_system')); ?> <span
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        document.getElementById ('logout-form').submit();"> <?php echo e(__('Logout')); ?> <i
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('funds.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manege_fund')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manege_publication')); ?></span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('papers.index')); ?>"><?php echo e(trans('message.publications2')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/books"><?php echo e(trans('message.book')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/patents"><?php echo e(trans('message.other_work')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('exportfile')); ?>" >
                            ...
                            <span class="menu-title"><?php echo e(trans('message.export')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('users.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.user')); ?></span>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-list')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('roles.index')); ?>">
                                ...
                                <span class="menu-title"><?php echo e(trans('message.role')); ?></span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('logs.index')); ?>">
                                ...
                                <span class="menu-title"><?php echo e(trans('message.log')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('departments.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.department')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('programs.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manege_program')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('experts.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manege_expertise')); ?></span>
...
<?php /**PATH E:\year3_2\softwareEng\soften_jectgroup\git-group-repository-group-2-sec-1\InitialProject\SourceCode\resources\views/dashboards/users/layouts/user-dash-layout.blade.php ENDPATH**/ ?>